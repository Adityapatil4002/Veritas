 ...
 * @access private
 */
interviewRouter.post("/resume/pdf/:interviewReportId", authMiddleware.authUser, interviewCotroller.generateInterviewReportController, generateResumePdfController)
